...
public class TampilTabel extends JFrame{ 
    ...
    TampilTabel () {
    super("Menampilkan Tabel"); setSize(400,240);
    ...
    // set Column width 
    TableColumn col = Tabel.getColumnModel().getColumn(0); col.setPreferredWidth (30);
...
public static void main(String args[]) {
    ...
    int i;
    for (i=0;i<=15;i++) {
        ModelTabel.insertRow(i, new Object[] {1+1, "NIM ke-"+i, "Nama ke- "+i, "Angkatan ke-"+i, "Kelas ke-"+i}); 
    }
